...
# S-Box (juste S1 pour simplifier)
S1=[
...
# Les tables de permutation pour la génération des clés
...
def generate_keys(key):
    ...
    return keys
#fonction utiliesée pour les permutations et les opérations de base
...
# déchiffrement
decrypted_bin = des_decrypt(cipher, key)
decrypted_text = bin_to_ascii(decrypted_bin)
